import{r as n,j as e,G as g,R as m,c as h}from"./ResultView-BUyCCZRO.js";const u=()=>{const[r,t]=n.useState("idle"),[o,i]=n.useState(null),[p,d]=n.useState(null),[s,l]=n.useState(null);n.useEffect(()=>{const c=a=>{switch(a.type){case"SCANNING":t("scanning"),l(a.imageUrl||null),i(null),d(null);break;case"SHOW_RESULT":t("result"),i({isAI:a.isAI||!1,confidence:a.confidence||0,heatmapData:a.heatmapData,filterData:a.filterData});break;case"ERROR":t("error"),d(a.error||"Unknown error");break}};return chrome.runtime.onMessage.addListener(c),()=>chrome.runtime.onMessage.removeListener(c)},[]);const b=()=>{t("idle"),i(null),d(null),l(null)};return r==="idle"?null:e.jsx("div",{className:"fixed inset-0 z-[999999] pointer-events-none flex items-center justify-center p-8",children:e.jsxs(g,{className:"pointer-events-auto relative overflow-hidden min-w-[320px] max-w-[400px] p-6",children:[e.jsxs("div",{className:"flex items-center gap-3 mb-4",children:[e.jsx("div",{className:"w-10 h-10 rounded-xl bg-gradient-to-br from-blue-500/30 to-purple-500/30 flex items-center justify-center border border-white/10",children:e.jsxs("svg",{className:"w-5 h-5 text-white",fill:"none",viewBox:"0 0 24 24",stroke:"currentColor",children:[e.jsx("path",{strokeLinecap:"round",strokeLinejoin:"round",strokeWidth:2,d:"M15 12a3 3 0 11-6 0 3 3 0 016 0z"}),e.jsx("path",{strokeLinecap:"round",strokeLinejoin:"round",strokeWidth:2,d:"M2.458 12C3.732 7.943 7.523 5 12 5c4.478 0 8.268 2.943 9.542 7-1.274 4.057-5.064 7-9.542 7-4.477 0-8.268-2.943-9.542-7z"})]})}),e.jsxs("div",{className:"flex-1",children:[e.jsx("h2",{className:"text-lg font-semibold",children:"UnDiffused"}),e.jsx("p",{className:"text-xs text-white/50 tracking-wider uppercase",children:"AI Image Detector"})]}),e.jsx("button",{onClick:b,className:"w-8 h-8 rounded-full bg-white/10 hover:bg-white/20 flex items-center justify-center transition-all duration-200 hover:scale-110 border border-white/10","aria-label":"Close",children:e.jsx("svg",{className:"w-4 h-4 text-white/70",fill:"none",viewBox:"0 0 24 24",stroke:"currentColor",children:e.jsx("path",{strokeLinecap:"round",strokeLinejoin:"round",strokeWidth:2,d:"M6 18L18 6M6 6l12 12"})})})]}),r==="scanning"&&e.jsxs("div",{className:"relative",children:[s&&e.jsxs("div",{className:"relative mb-4 rounded-xl overflow-hidden border border-white/10",children:[e.jsx("img",{src:s,alt:"Scanning",className:"w-full h-32 object-cover opacity-50"}),e.jsx("div",{className:"absolute inset-0",children:e.jsx("div",{className:"absolute inset-x-0 h-1 bg-gradient-to-r from-transparent via-blue-400 to-transparent animate-scanner shadow-[0_0_20px_rgba(59,130,246,0.8)]"})})]}),e.jsxs("div",{className:"flex items-center gap-3",children:[e.jsx("div",{className:"w-3 h-3 rounded-full bg-blue-500 animate-pulse-glow"}),e.jsx("span",{className:"text-sm text-white/70",children:"Analyzing image..."})]})]}),r==="result"&&o&&s&&e.jsx(m,{result:o,targetImage:s}),r==="error"&&e.jsxs("div",{className:"animate-fade-in",children:[e.jsx("div",{className:"inline-flex items-center gap-2 px-4 py-2 rounded-full bg-red-500/20 border border-red-500/30 mb-4",children:e.jsx("span",{className:"text-sm font-medium text-red-400",children:"Analysis Failed"})}),e.jsx("p",{className:"text-xs text-white/50",children:p})]}),e.jsx("div",{className:"absolute inset-x-0 bottom-0 h-px bg-gradient-to-r from-transparent via-white/20 to-transparent"})]})})},f=`
/* ===== TAILWIND BASE RESET ===== */
*, ::before, ::after {
...
`;function x(r){const t=document.createElement("style");t.textContent=f,r.appendChild(t)}if(!document.getElementById("undiffused-root")){const r=document.createElement("div");r.id="undiffused-root",document.body.appendChild(r);const t=r.attachShadow({mode:"open"});x(t);const o=document.createElement("div");o.id="undiffused-app",t.appendChild(o),h.createRoot(o).render(e.jsx(u,{})),console.log("[UnDiffused] Content script injected")}
